...
class Extractor():
    def __init__(self, path=None, url=None, depth=0, down_ext=['.csv', '.xls', '.xlsx', ".txt", ".sav", ".zip"],
        ...
        if path and url:
            raise ValueError(
                f'Use only path or url mode. If you need to use both, create 2 datainfos and merge it to the transformer')
